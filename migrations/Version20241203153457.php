 ...
 */
final class Version20241203153457 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE candidat (id INT AUTO_INCREMENT NOT NULL, utilisateur_id INT NOT NULL, nationalite VARCHAR(50) NOT NULL, date_naissance DATE NOT NULL, telephone VARCHAR(20) NOT NULL, poste VARCHAR(100) NOT NULL, date_disponibilite DATE NOT NULL, cv VARCHAR(255) DEFAULT NULL, lettre_motivation VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_6AB5B471FB88E14F (utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
